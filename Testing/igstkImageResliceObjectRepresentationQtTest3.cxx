/*=========================================================================
  ...
  Module:    igstkImageResliceObjectRepresentationQtTest3.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
namespace ImageResliceObjectRepresentationQtTest3
{
...
int igstkImageResliceObjectRepresentationQtTest3( int argc , char * argv [] )
{
  std::cout << " igstkImageResliceObjectRepresentationQtTest3: application started " << std::endl;
  ...
  typedef ImageResliceObjectRepresentationQtTest3::CTImageObserver 
                                                        CTImageObserverType;
  ...
  typedef ImageResliceObjectRepresentationQtTest3::VTKImageObserver 
  ...
  // Read a .msh mesh representing the tool
   ...
   typedef ImageResliceObjectRepresentationQtTest3::MeshObjectObserver 
